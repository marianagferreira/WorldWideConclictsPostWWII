...
dropdown_world_regions = dcc.Dropdown(
    ...
    value=['Europe', 'Africa', 'Americas', 'Asia & Oceania', 'Middle East'],  # remove Americas
...
app.layout = html.Div([
    ...
    html.Div([  # left bar with title, text. image, and references (fixed)
        ...
        ], style={'text-align': 'center', 'font-family': 'Brush Script MT', 'font-size': '25px'}),
        html.Br(),
        html.Div([
            html.Label('Bertrand Russell'),
        ], style={'text-align': 'center', 'font-family': 'Brush Script MT', 'font-size': '15px'}),
        html.Br(),
    ...
    html.Div([  # right part of the dashboard, with all the visualizations and filters
        ...
        html.Div([  # create a box in the assets, for the filters !!
            ...
            html.Div([  # second part --> range slider (10%)
                range_slider,
            ], style={'font-weight': 'bold', 'height': '10%', 'width': '85%', 'padding-left': '90px'},
                className='year_slider'),

        ], style={'height': '20%', 'width': '92%'}, className='box_filters'),
        ...
        ], style={'display': 'flex', 'padding-left': '80px'}),
        ...
        html.Div([  # fourth part --> world map and top_countries graph
            ...
            html.Div([  # map on the left
                ...
                html.Div([  # fifth part --> normal slider (10%)
                    normal_slider,
                ], style={'width': '90%', 'padding-left': '35px'}, className='year_slider2'),
            ], className="box", style={'width': '62%'}),
            ...
            ], style={'width': '38%', 'height': '250%'}, className='box'),

        ], style={'display': 'flex', 'height': '50%', 'padding-left': '80px'}),
        ...
        html.Div([
            ...
            ], style={'display': 'flex', 'padding-left': '350px', 'width': '60%', 'text-align': 'center'}),

            html.Div([  # last part --> references and authors
                html.Br(),
                html.Label('Source: https://ourworldindata.org/war-and-peace')
            ], style={'display': 'flex', 'padding-left': '375px', 'width': '30%', 'text-align': 'center'}),
...
def plots(projection, year):
    ...
    title_top_count = 'Countries with the highest number of deaths'

    bar_chart2 = (
        dict(data=dict(type='bar', y=filter_df2.sort_values(by='Total Deaths', ascending=False).iloc[:5, :].index,
